...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='phonecoin.conf'
CONFIGFOLDER='/root/.phonecoin'
COIN_DAEMON='phonecoind'
COIN_CLI='phonecoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://phonecoin.space/phonecoin-cli.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_CHAIN_LINK='https://phonecoin.space/phone_chain.zip'
COIN_CHAIN='phone_chain.zip'
COIN_NAME='phonecoin'
COIN_EXPLORER='http://chain.phonecoin.space'
COIN_PORT=12222
RPC_PORT=12221
